...
<form name="kecamatan_form" action="<?php echo $form_action;?>" method="post">
    <div  align="center">
    <fieldset>
        <legend>UPDATE DATA KECAMATAN</legend>
        ...
        <tr>
        <td width="150" height="25" align="right">ID Kecamatan</td>
        <td width="20">&nbsp;</td>
        <td><input type="text" name="kecamatanID" 
                   value="<?php
        ...
        <tr>
            <td height="25" align="right">Nama Kecamatan</td>
            <td width="20">&nbsp;</td>
        <td><input type="text" name="namaKecamatan" size="40" 
                   value="<?php echo set_value('namaKecamatan',  isset($default['namaKecamatan']) ? $default['namaKecamatan'] : '');?>" /></td>
        <tr>
            <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
